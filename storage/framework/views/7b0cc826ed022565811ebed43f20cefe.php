    ...
    <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      ...
      <?php if(Route::has('login')): ?>
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                    ...
                    <a href="<?php echo e(route('login')); ?>"><button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button></a>

                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>"><button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button></a>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 mb-12">
                    <article>
                        ...
                        <h2 class="text-white">Search results for <?php echo e($query); ?></h2>
                        <section class="mt-6 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-x-6 gap-y-8">
                            ...
                            <article class="relative w-full h-64 bg-cover bg-center group rounded-lg overflow-hidden shadow-lg hover:shadow-2xl  transition duration-300 ease-in-out"
                                style="background-image: url('<?php echo e($game->featured_image); ?>');">
                                ...
                                <div class="relative w-full h-full px-4 sm:px-6 lg:px-4 flex justify-center items-center">
                                    <h3 class="text-center">
                                        <a class="text-white text-2xl font-bold text-center" href="/game/<?php echo e($game->slug); ?>">
...
<?php /**PATH D:\laravel\Laravel-assessment\resources\views/search.blade.php ENDPATH**/ ?>