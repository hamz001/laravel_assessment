        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <main class="mt-10">
                ...
                <div class="mb-4 md:mb-0 w-full max-w-screen-md mx-auto relative" style="height: 24em;">
                    ...
                    <img src="<?php echo e($game->featured_image); ?>" class="absolute left-0 top-0 w-full h-full z-0 object-cover" />
                    ...
                    <div class="flex mt-3">
                        <img src="<?php echo e($game->featured_image); ?>"
                        class="h-10 w-10 rounded-full mr-2 object-cover" />
                        <div>
                        <p class="font-semibold text-gray-200 text-sm"> <?php echo e($game->uploaders->name); ?> </p>
                        <p class="font-semibold text-gray-400 text-xs"> <?php echo e(\Carbon\Carbon::parse($game->created_at)->diffForHumans()); ?> </p>
                        </div>
                    </div>
                    </div>
                </div>
                ...
                <div class="px-4 lg:px-0 mt-12 text-gray-700 max-w-screen-md mx-auto text-lg leading-relaxed">
                    <p class="pb-6"><?php echo e($game->article); ?></p>
...
<?php /**PATH D:\laravel\Laravel-assessment\resources\views/game.blade.php ENDPATH**/ ?>